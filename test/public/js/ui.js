 ...
 const wbCanvas = document.getElementById(
  ...
  if (wbCanvas) {
    wbCanvas.style.pointerEvents = "none";
     hideElement(wbCanvas);
  }
  
};

export const showElementUI = (id) => {
  showElement(id);
};

export const playAlert = () => {
  let audId = document.getElementById("audioId"); 
  audId.play();
};
...
export const showVideoCallButtons = () => {
  ...
  const personalCodeWVButton = document.getElementById(
    "personal_code_whiteboard_button"
  );

  showElement(personalCodeVideoButton);
  showElement(personalCodeWVButton);
};
...
export const showIncomingCallDialog = (
  ...
  let callTypeInfo =
    ...
    if (callType === constants.callType.WB_PERSONAL_CODE) {
      callTypeInfo = "Whiteboard Collab";
    }
...
export const showInfoDialog = (preOfferAnswer) => {
  ...
  if (preOfferAnswer === constants.preOfferAnswer.CALL_REJECTED) {
    infoDialog = elements.getInfoDialog(
      "Call rejected",
      "Collaborator rejected your call"
    );
  }
