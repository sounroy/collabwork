...
export const appendPoint = (message) => {
    onPeerData(null,message);
  };
...
function broadcast(data) {
   // console.log(" Sending canvas data");
    // console.debug(data);
    webRTCHandler.sendMessageUsingDataChannel(data);
...
function onPeerData(id, data) {
    ...
    let msg = JSON.parse(JSON.parse(data));
  //  console.log("inside peer data");
   // console.log("msg"+msg);
   // draw(JSON.parse(msg));
    if (msg.event === 'draw') {
        draw(msg);
