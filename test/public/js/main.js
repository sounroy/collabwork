...
const personalCodeWBButton = document.getElementById(
  "personal_code_whiteboard_button"
);
...
personalCodeWBButton.addEventListener("click", () => {
  const calleePersonalCode = document.getElementById(
    "personal_code_input"
  ).value;
  const callType = constants.callType.WB_PERSONAL_CODE;
  store.setCallType(callType);
 // document.getElementById("local_canvas_container").display();
